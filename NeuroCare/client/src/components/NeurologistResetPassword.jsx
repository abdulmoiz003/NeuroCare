...
import styles from "./styles/NeurologistResetPassword.module.css"
...
function ResetPasswordModal({ isOpen, onClose, email, previousPath }) {
  ...
  const handleVerifyPassword = () => {
    axios
      .post("http://localhost:5000/NeurologistVerifyPassword", { email, currentPassword })
      .then(() => {
        ...
        axios
          .post("http://localhost:5000/NeurologistResetPassword", { email, newPassword })
          .then((response) => {
