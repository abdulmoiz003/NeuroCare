...
const SystemRatings = () => {
  ...
  useEffect(() => {
    const fetchRatings = async () => {
      try {
        const response = await axios.get("http://localhost:5000/getrating"); // Adjust the endpoint as necessary
  ...
  return (
    ...
    <div className={styles.tableContainer}>
      <h2 className={styles.heading}>NeuroCare System Ratings</h2>
