    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                <Text style={styles.header}>Personalized Exercise Plans</Text>
            </View>

            {/* Diet and Exercise Plan buttons */}
            <TouchableOpacity
                style={styles.button}
                onPress={() => navigation.navigate('ParkinsonExercises')}
            >
                <Image
                    source={require('../assets/pex.jpg')} // Add your diet image here
                    style={styles.image}
                />
                <Text style={styles.buttonText}>Parkinson's Exercises</Text>
            </TouchableOpacity>

            <TouchableOpacity
                style={[styles.button, styles.exerciseButton]} // Apply additional margin only to this button
                onPress={() => navigation.navigate('AlzheimerExercises')}
            >
                <Image
                    source={require('../assets/aex.jpg')} // Add your exercise image here
                    style={styles.image}
                />
                <Text style={styles.buttonText}>Alzheimer's Exercises</Text>
            </TouchableOpacity>

            <TouchableOpacity
                style={[styles.button, styles.exerciseButton]} // Apply additional margin only to this button
                onPress={() => navigation.navigate('StrokeExercises')}
            >
                <Image
                    source={require('../assets/bex.jpeg')} // Add your exercise image here
                    style={styles.image}
                />
                <Text style={styles.buttonText}>Brain Stroke Exercises</Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    exerciseButton: {
        marginBottom: 30, // Increase margin specifically for Exercise Plans button
    },
    image: {
