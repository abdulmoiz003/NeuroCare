    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                <Text style={styles.header}>Saved Lifestyle Plans</Text>
            </View>

            {/* Diet and Exercise Plan buttons */}
            <TouchableOpacity
                style={styles.button}
                onPress={() => navigation.navigate('SavedDietPlans')}
            >
                <Image
                    source={require('../assets/diet1.jpg')} // Add your diet image here
                    style={styles.image}
                />
                <Text style={styles.buttonText}>My Diet Plans</Text>
            </TouchableOpacity>
            ...
            >
                <Image
                    source={require('../assets/exercise1.jpg')} // Add your exercise image here
                    style={styles.image}
                />
                <Text style={styles.buttonText}>My Exercise Plans</Text>
            </TouchableOpacity>
