...
const ParkinsonDetection = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('http://10.0.2.2:6000/predict', formData, {
        headers: {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Parkinson's Disease Detection</Text>
      <Image
        source={require('../assets/img1.png')}
        style={styles.roundedImage}
      />
      <Text style={styles.label}>Upload spiral drawing image:</Text>
        ...
        <View style={styles.resultContainer}>
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('ParkReport', { detectionResult })}
            >
              <Image
            ...
            <TouchableOpacity
              style={styles.imageButton}
              onPress={() => navigation.navigate('ParkRecom', { detectionResult })}
            >
              <Image
...
export default ParkinsonDetection;