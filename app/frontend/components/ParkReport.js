...
const ParkReport = ({ route }) => {
  ...
  const saveReport = async () => {
    try {
      ...
      if (email && patientDetails) {
        const response = await axios.post('http://10.0.2.2:5000/saveReport', {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Parkinson's Disease Detection Report</Text>
      <View style={styles.reportContainer}>
        ...
        <View style={styles.reportItem}>
          ...
          <Text style={styles.value}>Parkinson</Text>
        </View>
        <View style={styles.reportItem}>
          <Text style={styles.label}>Detection Result:</Text>
          <Text style={[styles.value, detectionResult === 'parkinson' ? styles.positiveResult : styles.negativeResult]}>
            {detectionResult}
          </Text>
        </View>
        <View style={styles.reportItem}>
